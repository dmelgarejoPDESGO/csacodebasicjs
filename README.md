...
- Navigate to `csacodebasicjs` folder
- Select `csacodebasicjs.bot` file
...
msbot clone services --name "csacodebasicjs" --code-dir "." --location <azure region like eastus, westus, westus2 etc.> --sdkLanguage "Node" --folder deploymentScripts/msbotClone --verbose
```
